<template>
  <div
    class="h-full flex flex-col p-2 border-r-2 border-blue-100 text-gray-500 font-medium"
  ...
  >
    ...
    >
      ...
      <span v-show="localSidebarLarge" class="ml-1"> Операции </span>
    </router-link>
    ...
    >
      ...
      <span v-show="localSidebarLarge" class="ml-1"> Отчёт </span>
    </router-link>
